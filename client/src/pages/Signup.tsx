...
const Signup: React.FC = () => {
  ...
  const onSubmit = async (values: FormValues) => {
    try {
      setLoading(true);
      const { user, error } = await registerWithEmailAndPassword(values.email, values.password);
      ...
      if (user) {
        ...
        // Register with your existing UserContext
        await register(username, values.password, values.referralCode);
        ...
        <div className="w-full max-w-md px-4">
          <Card className="w-full">
            <CardHeader className="space-y-1 text-center">
              ...
              <CardDescription>
                Enter your details to create your Indian OTP account
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full bg-[#138808] hover:bg-opacity-90"
                    disabled={loading}
                  >
                    {loading ? (
                      <>
